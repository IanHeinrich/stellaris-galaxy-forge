...
- [ ] A system added with Sol loads with Jupiter's four moons on the same sides of Jupiter as in the game's own Sol (`testdata/4.4-early.sav`), and a month passes cleanly
