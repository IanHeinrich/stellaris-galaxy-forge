...
/**
 * Whether the generator draws this system at all: a base above zero, a modifier that adds
 * weight on its own (a mod's `base = 0` plus `add = 10000` for one empire is a spawn point for
 * that empire), or a script that names the seat.
 */
